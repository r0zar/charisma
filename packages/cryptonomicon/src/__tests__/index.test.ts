...
describe("@repo/cryptonomicon", () => {
  ...
  it("reads a LP contract (POV)", async () => {
    ...
    await client.getTokenBalance('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.perseverantia-omnia-vincit', 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS')
    // console.log(tokenResponse);
    // expect(tokenResponse).toBeDefined();
  })
  ...
  it('get all dexterity vaults', async () => {
    ...
    console.log(contracts.map(c => c.contract_id));
