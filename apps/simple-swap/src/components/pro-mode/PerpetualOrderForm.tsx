        ...
        <TooltipProvider delayDuration={300} skipDelayDuration={100}>
            <div className="space-y-3 relative">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-xs">
                            {perpetualMarginRequired > 0 && (
                                <div>
                                    ...
                                    <div className="font-medium text-muted-foreground">{formatUsd(perpetualMarginRequired)}</div>
                                </div>
                            )}
                ...
                <Button
                    ...
                    disabled={!perpetualPositionSize || !selectedFromToken || !selectedToToken || !perpetualEntryPrice || isSubmitting}
                    className="w-full h-10 text-sm font-medium"
                >
                    {isSubmitting ? 'Creating...' : `Create ${perpetualDirection === 'long' ? 'Long' : 'Short'} Position (Preview)`}
                </Button>
