...
export default function SandwichOrderForm() {
    ...
    return (
        <div ref={containerRef} className="space-y-6 max-w-4xl">
            {/* Sandwich Trading Logic Section */}
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                    className="w-32 bg-transparent border border-border/40 rounded px-2 py-1 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/20 placeholder:text-muted-foreground/50"
                                />
                                <span className="text-xs text-muted-foreground whitespace-nowrap">
