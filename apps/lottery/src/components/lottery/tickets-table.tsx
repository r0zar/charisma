...
import { Loader2, ExternalLink, CheckCircle2, ChevronDown, ChevronRight, Copy } from 'lucide-react'
...
export function TicketsTable({ tickets, onConfirmationUpdate, onBulkConfirmationUpdate }: TicketsTableProps) {
  if (tickets.length === 0) {
    return (
