...
export const size = {
    width: 1200,
    height: 675, // Twitter prefers 1200x675
};

export const contentType = 'image/png';

// Image generation (reusing most of the OG image design but optimized for Twitter)
export default async function Image() {
    try {
            ...
            (
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ fontSize: 22, opacity: 0.7, maxWidth: 700 }}>
                            Commit CHA. Choose a meme token. Pump together.
                        </div>
                    </div>
                </div>
            ),
        ...
        console.error(`Error generating Twitter image: ${e}`);
