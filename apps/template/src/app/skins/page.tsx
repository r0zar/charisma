          ...
          {skins.map((skin) => (
            <Card 
              ...
              className={`cursor-pointer transition-all hover:shadow-lg ${
                mounted && currentSkin === skin.id ? "ring-2 ring-primary" : ""
              }`}
              onClick={mounted ? () => applySkin(skin.id) : undefined}
            >
              ...
              <CardContent>
                {/* Preview */}
                <div className={`h-24 rounded-lg mb-4 ${skin.preview}`} />
