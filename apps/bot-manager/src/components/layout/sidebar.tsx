  ...
  return (
    <>
      ...
      <div className={cn('hidden lg:block', className)}>
        <div className="fixed inset-y-0 left-0 w-64 bg-background border-r border-border/25">
          <SidebarContent />
        </div>
      </div>
      ...
      <Sheet>
        <SheetTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="lg:hidden fixed top-4 left-4 z-50 bg-background/80 backdrop-blur-sm border border-border/25"
          >
            <Menu className="w-5 h-5" />
          </Button>
        </SheetTrigger>
        <SheetContent side="left" className="w-64 p-0 bg-background border-border/25">
          <SidebarContent />
        </SheetContent>
      </Sheet>
    </>
