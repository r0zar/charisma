/**
 * INVEST Oracle Adapter - Uses INVEST API prices
 * 
 * Fetches token prices from https://invest.charisma.rocks/api/v1/prices
 */
  ...
  private async fetchPricesFromApi(): Promise<void> {
    try {
      ...
      try {
        ...
        throw new Error(`INVEST API returned invalid JSON: ${parseError.message}`);
      }
